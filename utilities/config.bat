title GoAnimate 2014 Reset Script
...
:error_location
echo Doesn't seem like this script is in GoAnimate 2014's utilities folder.
goto end
:noerror_location
...
:: Confirmation
echo Are you sure you'd like to reset GoAnimate 2014?
echo This will remove all saved videos and characters.
echo You should only use this if you're a developer, one told you to do it, or if you're experiencing a big issue.
echo This action is permanent, and can't be reversed.
echo:
echo Type y to reset GoAnimate 2014, and n to close this script.
:resetconfirmretry
