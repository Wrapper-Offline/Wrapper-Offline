...
if !_rand!==16 echo IT'S SO SCARY^^!^^!^^!^^!^^!^^!
goto wrapperidle
...
echo:>> utilities\config.bat
echo :: auto update (what do you think it does, obvious). Default: y>> utilities\config.bat
echo set AUTOUPDATE=y>> utilities\config.bat
echo:>> utilities\config.bat
echo :: discord rich presence. Default: n>> utilities\config.bat
