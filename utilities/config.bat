...
:: Shows exactly what GoAnimate 2014 is doing, and never clears the screen. Useful for development and troubleshooting. Default: n
...
:: Opens GoAnimate 2014 in an included copy of ungoogled-chromium. Allows continued use of Flash as modern browsers disable it. Default: y
...
:: Opens GoAnimate 2014 in a browser of the user's choice. Needs to be a path to a browser executable in quotes. Default: n
set CUSTOMBROWSER=n
